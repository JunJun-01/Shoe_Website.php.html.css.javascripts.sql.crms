    ...
    <body>
        <header>
          ...
          <div id="welcome">
            ...
            <!-- navigation bar anchor to specific products -->
          <div class="navbar">
                ...
                <div class="row1 g-2">
                    <div class="col-md-3">
                            <div class="Filter">
                                ...
                                <div>
                                    ...
                                    <div class="d-flex justify-content-between mt-2">
                                        <div class="boxcon"><a href="./catogory/product_men.php" style="color: black; text-decoration:none;">Men</a></div>
                                        <br>
                                    </div>
                                    <div class="d-flex justify-content-between mt-2">
                                        <div class="boxcon"><a href="./catogory/product_woman.php" style="color: black; text-decoration:none;">Woman</a></div>
                                        <br>
                                    </div>
                                    <div class="d-flex justify-content-between mt-2">
                                        <div class="boxcon"><a href="./catogory/product_kid.php" style="color: black; text-decoration:none;">Kid</a></div>
                                        <br>
                                    </div>
                                </div>
                            </div>
                            <div class="Brand">
                                ...
                                <div class="d-flex justify-content-between mt-2">
                                    <div class="boxcon"><a href="./catogory/product_nike.php" style="color: black; text-decoration:none;">NIKE</a></div>
                                    <br>
                                </div>
                                <div class="d-flex justify-content-between mt-2">
                                    <div class="boxcon"><a href="./catogory/product_adidas.php" class="boxcon" style="color: black; text-decoration:none;">ADIDAS</a></div>
                                    <br>
                                </div>
                                <div class="d-flex justify-content-between mt-2">
                                    <div class="boxcon"><a href="./catogory/product_asics.php" style="color: black; text-decoration:none;">ASICS</a></div>
                                    <br>
                                </div>
                            </div>
        ...
        <!-- product card -->
        <!-- search the specific product in mysql and using while loop to print all the item  -->
                ...
                <div class="col-sm d-flex">
                    <?php 
                        ...
                        if(strlen($queryy)> 0){
                            ...
                            $query2 = "SELECT * FROM shoe WHERE (`ShoeName` LIKE '%".$queryy."%')";

                            $query3= $query2 or die(mysqli_error($con));
                            ...
                            if(mysqli_num_rows($query4) >= 0){
                                while($result = mysqli_fetch_array($query4)){
                                    ...
                                    echo "<p2>$price</p2>";
                                    echo "<div class='but'>";
                                    echo "<input type='submit' name='addtocart' value='Add to Cart' onclick='additem()'>";
                                    echo "</form>";
                                    echo "</div>";
                                    echo "</div>";
                                }
                            }else{
                                echo "Shoe Does Not Exist!";
                        }}
                            // when user press add to cart button it will add the item into cart database and send a message to user that item added to cart
                            if(isset($_POST['addtocart'])){
                              $prodname = $_POST['shoename'];
