...
<html lang="en">
    ...
    <body>
        ...
        <!-- product card -->
        <!-- connect database and select all from specfic table -->
        <!-- using foreach to display all the products -->
        <div class="container">
            <div class="row">
                ...
                <?php
                        ...
                        // when press add to cart button add the item in to cart table and send message to user that item added to cart
